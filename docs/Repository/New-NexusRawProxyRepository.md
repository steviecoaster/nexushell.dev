...
### Default (Default)
```
New-NexusRawProxyRepository -Name <String> -ProxyRemoteUrl <String> -ContentDisposition <String>
 [-ContentMaxAgeMinutes <String>] [-MetadataMaxAgeMinutes <String>] [-QueryCacheItemMaxAgeSeconds <String>]
 [-UseNegativeCache] [-NegativeCacheTTLMinutes <String>] [-CleanupPolicy <String>] [-RoutingRule <String>]
 [-Online] [-BlobStoreName <String>] [-StrictContentValidation] [-UseNexusTrustStore]
...
New-NexusRawProxyRepository -Name <String> -ProxyRemoteUrl <String> -ContentDisposition <String>
 [-ContentMaxAgeMinutes <String>] [-MetadataMaxAgeMinutes <String>] [-QueryCacheItemMaxAgeSeconds <String>]
 [-UseNegativeCache] [-NegativeCacheTTLMinutes <String>] [-CleanupPolicy <String>] [-RoutingRule <String>]
 [-Online] [-BlobStoreName <String>] [-StrictContentValidation] [-UseNexusTrustStore] [-UseAuthentication]
